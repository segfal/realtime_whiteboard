...
export class SelectTool implements DrawingTool {
    ...
    isPointNearStroke(point: WASMPoint, strokePoints: WASMPoint[], threshold: number = 8): boolean {
    ...
    strokeIntersectsRect(strokePoints: WASMPoint[], rect: SelectionBounds): boolean {
        return strokePoints.some(point => 
