...
test.describe("Whiteboard Application", () => {
  ...
  test("should switch between tools", async ({ page }) => {
    ...
    await expect(page.locator('button[title="Rectangle"]')).toHaveCSS(
      "border",
      /2px solid #007bff/,
    );
    await expect(page.locator('button[title="Pen"]')).toHaveCSS(
    ...
    await expect(page.locator('button[title="Ellipse"]')).toHaveCSS(
      "border",
      /2px solid #007bff/,
    );
    ...
    await expect(page.locator('button[title="Eraser"]')).toHaveCSS(
      "border",
      /2px solid #007bff/,
    );
    ...
    await expect(page.locator('button[title="Select"]')).toHaveCSS(
      "border",
      /2px solid #007bff/,
    );
