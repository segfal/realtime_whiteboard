...
/** not-@type {!BigUint64Array} */
    ...
    function findWasmBinary() {
      return locateFile("drawing_engine.wasm");
    }
    ...
    var __embind_register_integer = (
      ...
      registerType(primitiveType, {
        ...
        toWireType: (destructors, value) => {
          if (typeof value != "number" && typeof value != "boolean") {
            throw new TypeError(
              `Cannot convert "${embindRepr(value)}" to ${name}`,
            );
          }
          assertIntegerRange(name, value, minRange, maxRange);
          // The VM will perform JS to Wasm value conversion, according to the spec:
    ...
    var __embind_register_std_wstring = (rawType, charSize, name) => {
      ...
      if (charSize === 2) {
        ...
        assert(
          charSize === 4,
          "only 2-byte and 4-byte strings are currently supported",
        );
...
if (typeof exports === "object" && typeof module === "object") {
  module.exports = DrawingEngineModule;
  // This default export looks redundant, but it allows TS to import this
  // commonjs style module.
  module.exports.default = DrawingEngineModule;
} else if (typeof define === "function" && define["amd"])
  define([], () => DrawingEngineModule);
